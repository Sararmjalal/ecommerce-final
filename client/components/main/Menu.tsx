...
const Menu = ({ closeHandler, categories }: {closeHandler: () => void, categories: Category[]}) => {
  ...
  return (
    <div className="relative">
      <div className={`${router.asPath !== '/' ? 'top-0' : 'top-[100px]'} absolute py-9 flex-wrap md:px-6 md:justify-between 
      flex px-48 gap-10 w-full bg-white z-[999] shadow-md border-t-[1px] border-grayborder`}
