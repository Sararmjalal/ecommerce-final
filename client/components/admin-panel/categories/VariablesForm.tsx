  ...
  return (
    <div
      ...
      <div
        ...
        <div className='md:w-max w-1/3 mr-0 text-2xl md:mr-1'><MdRemoveCircle /></div>
        <div className='hidden font-semibold md:block'>Remove Variable</div>
      </div>
      ...
      <div className='w-1/3 md:w-full'>
        ...
        <>
          ...
          <div
            ...
            <div className='w-max flex items-center gap-1 mt-2'><IOIcons.IoAddCircle /><div>Add More Options</div></div>
          </div>
        </>
      )}
    </div>
